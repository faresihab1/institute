...
const LessonPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchLesson = async () => {
      ...
      try {
        ...
        const data = await apiFetchJson<{ data?: LessonDetails; message?: string }>(`/lessons/${lessonId}`, {
          method: 'GET',
          locale,
          auth: true,
          token,
  ...
  const handleCompleteLesson = async () => {
    ...
    try {
      const data = await apiFetchJson<any>(`/lessons/${lessonId}/complete`, {
        method: 'POST',
        auth: true,
        token
      })
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    {toDisplayString(lesson.text_content) || 'No text content available for this lesson.'}
                  </div>
                </div>
              </div>
